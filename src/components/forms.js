    ...
    return (
        ...
        <div className="form-box">
            <div className="button-box">
                ...
                <button type="button" className="toggle-btn" ref={t} id="LostFB" onClick={Found}>Lost Post</button>
                <button type="button" className="toggle-btn" ref={r} id="FoundFB" onClick={Lost}>Found Post</button>
                
            </div>
            <form ref ={x} id="LostForm" className="inputG">
                <div>
                    <label>Full Name</label>
                <input type="text" id="fullname"  className="input-field"  name="full_name" placeholder="  khalid alharbi" required/>
                <label> Email</label>
                <input type="email" name="email"  className="input-field" placeholder="XXXX@domain.com" required/>
            </div>
            ...
            <label>where did you lost it?</label>
                ...
                <textarea name="description"   className="input-field" cols="30" rows="4" placeholder="green iphone with a blue cover" required></textarea>
                <div className="file-input">
                    <input type="file" id="file" className="file"/>
                    <label htmlFor="file">upload image</label>
                  </div>
                 <br/>
                <button type="submit" className="sumbit-btn">create post</button>
            </form>
