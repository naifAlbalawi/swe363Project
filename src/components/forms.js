...
function Forms() {
  ...
  if (el) {
    document
      .getElementById("found-btn")
      .addEventListener("click", () => setFound(true));
  }

  var el2 = document.getElementById("lost-btn");
  if (el2) {
    document
      .getElementById("lost-btn")
      .addEventListener("click", () => setFound(false));
  }
  ...
  return (
    <div className="container-form" id="FormBack">
